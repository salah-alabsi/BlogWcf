...
namespace BlogClientWinForms.BlogServiceReference {
    ...
    public interface IBlogService {
        ...
        BlogClientWinForms.BlogServiceReference.BlogPost AddPost(string title, string content);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBlogService/AddPost", ReplyAction="http://tempuri.org/IBlogService/AddPostResponse")]
        System.Threading.Tasks.Task<BlogClientWinForms.BlogServiceReference.BlogPost> AddPostAsync(string title, string content);
        ...
        BlogClientWinForms.BlogServiceReference.BlogPost[] GetPosts();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBlogService/GetPosts", ReplyAction="http://tempuri.org/IBlogService/GetPostsResponse")]
        System.Threading.Tasks.Task<BlogClientWinForms.BlogServiceReference.BlogPost[]> GetPostsAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBlogServiceChannel : BlogClientWinForms.BlogServiceReference.IBlogService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BlogServiceClient : System.ServiceModel.ClientBase<BlogClientWinForms.BlogServiceReference.IBlogService>, BlogClientWinForms.BlogServiceReference.IBlogService {
        ...
        public BlogClientWinForms.BlogServiceReference.BlogPost AddPost(string title, string content) {
            return base.Channel.AddPost(title, content);
        }
        
        public System.Threading.Tasks.Task<BlogClientWinForms.BlogServiceReference.BlogPost> AddPostAsync(string title, string content) {
            return base.Channel.AddPostAsync(title, content);
        }
        
        public BlogClientWinForms.BlogServiceReference.BlogPost[] GetPosts() {
            return base.Channel.GetPosts();
        }
        
        public System.Threading.Tasks.Task<BlogClientWinForms.BlogServiceReference.BlogPost[]> GetPostsAsync() {
